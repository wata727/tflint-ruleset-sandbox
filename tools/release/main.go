...
func checkGitStatus() error {
	...
	if !strings.Contains(strings.TrimSpace(stdout.String()), "wata727/tflint-ruleset-sandbox") {
		return fmt.Errorf("remote.origin is not wata727/tflint-ruleset-sandbox, got %s", strings.TrimSpace(stdout.String()))
	}
	return nil
}
